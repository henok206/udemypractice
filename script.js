  ...
  //  console.log(friends);//['Mesay',abebe','kebede','Moges','Aster','Almaz']
   ...
   //
    ...
    // console.log(amplitude);
        ...
        //Merge two array
        // const calTemAmpNew=function(t1,t2){
        ...
        // }
        //calTemAmp([3,7,9,78]);
        //  const amplitudeNew=calTemAmpNew([1,2,3],[4,5,6]);
        // console.log(amplitudeNew);
         
        // how to fix BUG
        //example
        // const meseringKelvin=function(){
        //    const meserment={
        //       type:'temp',
        //      unit:'celsius',
        //      //FIXME by converting from string to num vidio 61
        //      //value:Number(prompt(`Deegre celsius:`)),
        //    }
        //    const kelvin= meserment.value +273;
        //    return kelvin;
        // }

        //  console.log(meseringKelvin());
        /*Coding Challenge #1
